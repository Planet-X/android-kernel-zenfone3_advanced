...
static DEVICE_ATTR(msm_enabled, 0644, show_enable_hotplug,
		   store_enable_hotplug);
static DEVICE_ATTR(down_lock_duration, 0644, show_down_lock_duration,
...
static DEVICE_ATTR(history_size, 0644, show_history_size, store_history_size);
...
static DEVICE_ATTR(fast_lane_min_freq, 0644, show_fast_lane_min_freq,
